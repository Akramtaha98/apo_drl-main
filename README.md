...
---
>>>>>>> d0741cb (Final revised manuscript v17)
...
=======
│   └── extract_tables.py   # Paper table generation (Table 5 & 6)
>>>>>>> d0741cb (Final revised manuscript v17)
...
This forces the agent to revisit QoS-violating experiences more frequently, accelerating convergence on hard constraints.
>>>>>>> d0741cb (Final revised manuscript v17)
...
=======
# Train the full APO-DRL agent (5 seeds, 3000 episodes, 1000 devices)
python src/train.py --method apo_drl --seeds 0 42 123 256 999 --episodes 3000 --devices 1000

# Train all baselines
python src/train.py --method dqn       --seeds 0 42 123 256 999 --episodes 3000 --devices 1000
python src/train.py --method d3qn_per  --seeds 0 42 123 256 999 --episodes 3000 --devices 1000
python src/train.py --method static    --seeds 0 42 123 256 999 --episodes 100  --devices 1000
python src/train.py --method ahp_topsis --seeds 0 42 123 256 999 --episodes 100 --devices 1000
python src/train.py --method random    --seeds 0 42 123 256 999 --episodes 100  --devices 1000

# Scalability study (Table 6)
for N in 500 1500 2000; do
  python src/train.py --method apo_drl --seeds 0 42 123 --episodes 3000 --devices $N
  python src/train.py --method static  --seeds 0 42 123 --episodes 100  --devices $N
>>>>>>> d0741cb (Final revised manuscript v17)
done
...
| `fig4_bars.png` | Performance bar chart at N=1000 |
| `fig6_scalability.png` | Throughput & QoS vs. device density |

---

## Paper Tables (`extract_tables.py`)
>>>>>>> d0741cb (Final revised manuscript v17)
...
=======
- **Table 5**: Full performance comparison at N=1000 (mean ± std over seeds)
- **Table 6**: Scalability across N = 500 / 1000 / 1500 / 2000
- **Improvement %** of APO-DRL vs. Static (for Abstract/Conclusion)
